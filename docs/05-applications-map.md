...
> English (primary) · [Русский](../translations/ru/docs/05-applications-map.md) · [Deutsch](../translations/de/docs/05-applications-map.md) · [Português](../translations/pt/docs/05-applications-map.md)
