...
> English (primary) · [Русский](../translations/ru/docs/03-discovery-protocol.md) · [Deutsch](../translations/de/docs/03-discovery-protocol.md) · [Português](../translations/pt/docs/03-discovery-protocol.md)
