...
Die Schematics werden aus Code generiert – [render_schematics.py](render_schematics.py) dient als Design-Quelle (schemdraw); um Änderungen vorzunehmen, bearbeiten Sie das Skript und regenerieren Sie es dann:
