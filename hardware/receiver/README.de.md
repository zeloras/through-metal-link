...
Schemazeichnungen: [Stufe 1 — sch2](../schematics/sch2-receiver-stage1.de.png) · [Stufe 4 — sch4](../schematics/sch4-receiver-node.de.png) (generiert durch [../schematics/render_schematics.py](../schematics/render_schematics.py))
