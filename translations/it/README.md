...
- **A — dry-run:** sweep simulato + [simulatore](../../software/simulator/channel_sim.py) (nessun banco)
- **B — assembla fase 1:** [QUICKSTART.md](QUICKSTART.md) → [esperimenti/001](experiments/001-sweep-map-3mm-steel/README.md)
- **C — contribuisci senza hardware:** prior-art / docs / traduzioni / commenti ADR ([CONTRIBUTING.md](CONTRIBUTING.md))

**Stato:** fase 0 — preparazione · **nessuna validazione hardware ancora** (solo simulatore; taglia per il primo assemblaggio) · 💰 **[taglia di $250](https://github.com/zeloras/through-metal-link/issues/5)** · lista della spesa: [QUICKSTART.md](QUICKSTART.md)
...
Le onde radio non attraversano il metallo (gabbia di Faraday), e un passaggio per cavo significa un foro, una tenuta e un punto di guasto. Gli ultrasuoni, d'altra parte, attraversano il metallo senza problemi: un elemento piezo su ciascun lato della parete lo trasforma in un canale per alimentazione e dati. La letteratura di laboratorio ha già dimostrato la fisica a livelli consistenti (RPI: 50 W + 12 Mbit/s attraverso 63,5 mm di acciaio; NASA JPL: fino a ~kW attraverso 5 mm di titanio) — si tratta di prove di esistenza con hardware specializzato, non della BOM da garage di questo repo. I brevetti fondamentali sono scaduti, e non esiste ancora una piattaforma aperta e riproducibile — questo repository ne sta costruendo una, partendo da **potenza dell'ordine dei watt e dati in kbit/s attraverso 3–5 mm di acciaio** non appena lo stadio 2 sarà misurato.

## Roadmap

| Fase | Deliverable | Criterio di successo | Attesa |
|---|---|---|---|
...
| Modalità | Frequenza | Risonanza impostata da | Fornisce | Stato |
|---|---|---|---|---|
