...
- Stufe 2 (Watt): RX → dieselbe Brücke → bekannter widerständiger Last (und/oder LED), messen von DC-Spannung und -Strom nach der Brücke; Leistung ist V·I in diese Last. Protokoll: [experiments/002](../../experiments/002-watts-3mm-steel/README.md).
