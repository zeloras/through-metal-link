...
ठोस धातु की दीवारों के पार अल्ट्रासोनिक बिजली और डेटा ट्रांसफर के लिए एक ओपन प्लेटफ़ॉर्म — "बिना एक भी छेद के स्टील के पार", गैरेज-ग्रेड साधनों से बना।
...
- **B — बिल्ड स्टेज 1:** [QUICKSTART.md](QUICKSTART.md) → [experiments/001](experiments/001-sweep-map-3mm-steel/README.md)
- **C — बिना हार्डवेयर के योगदान:** पूर्व-कार्य / डॉक्स / अनुवाद / ADR टिप्पणियाँ ([CONTRIBUTING.md](CONTRIBUTING.md))

**स्थिति:** स्टेज 0 — तैयारी · **अभी तक कोई हार्डवेयर सत्यापन नहीं** (केवल सिम्युलेटर; पहले बिल्ड के लिए बाउंटी) · 💰 **[$250 बाउंटी](https://github.com/zeloras/through-metal-link/issues/5)** · खरीद सूची: [QUICKSTART.md](QUICKSTART.md)
...
रेडियो तरंगें धातु से नहीं गुज़रतीं (फैराडे पिंजरा), और केबल का प्रवेश का मतलब है एक छेद, एक सील, और एक विफलता का बिंदु। दूसरी ओर, अल्ट्रासाउंड धातु से बिल्कुल आसानी से गुज़रता है: दीवार के दोनों ओर एक-एक पीज़ो तत्व इसे बिजली और डेटा के लिए एक चैनल में बदल देता है। प्रयोगशाला साहित्य में पहले ही गंभीर स्तरों पर भौतिकी सिद्ध हो चुकी है (RPI: 63.5 मिमी स्टील के माध्यम से 50 W + 12 Mbit/s; NASA JPL: 5 मिमी टाइटेनियम के माध्यम से ~kW तक) — ये विशेष हार्डवेयर के साथ अस्तित्व के प्रमाण हैं, इस रेपो के गैराज BOM के नहीं। आधारभूत पेटेंट समाप्त हो चुके हैं, और अभी तक कोई खुला, पुनरुत्पादन योग्य प्लेटफ़ॉर्म मौजूद नहीं है — यह रिपॉज़िटरी एक ऐसा बना रही है, जो चरण 2 के मापन के बाद **3–5 मिमी स्टील के माध्यम से वाट-श्रेणी की बिजली और kbit/s डेटा** से शुरुआत करेगी।

## रोडमैप

| चरण | परिणाम | सफलता का मापदंड | अपेक्षा |
|---|---|---|---|
| 1. स्वीप मानचित्र | "Langevin–3 mm स्टील–Langevin" चैनल की आवृत्ति प्रतिक्रिया | युग्म अनुनाद मिला, प्लॉट [experiments/001](experiments/001-sweep-map-3mm-steel/README.md) में | [sim1](../../docs/img/sim1-sweep-contacts.png), [sim2](../../docs/img/sim2-pair-mismatch.png) |
| 2. वाट | अनुनाद पर लोड में शक्ति | 3 mm स्टील के आर-पार ≥0.5 W, प्रोटोकॉल [experiments/002](experiments/002-watts-3mm-steel/README.md) में | [sim4](../../docs/img/sim4-power-budget.png) |
| 3. डेटा | उसी युग्म पर FSK/OOK | ≥1 kbit/s त्रुटि-मुक्त | [sim5](../../docs/img/sim5-ook-datarate.png) |
| 4. नोड | वेल्डेड-बंद बॉक्स में ESP32 + सेंसर, केवल ध्वनि से शक्तिप्रदान और टेलीमेट्री | ≥1 घंटा स्वायत्त संचालन | [sim4](../../docs/img/sim4-power-budget.png) |
| 5. प्रकाशन | पहली स्वतंत्र प्रतिकृति + लेख/कैसे-करें + Zenodo स्नैपशॉट | तृतीय-पक्ष पुनरुत्पादन प्रलेखित | — |
...
3. **कान** — गैर-तुच्छ शक्ति पर, धातु से दबे ट्रांसड्यूसर संचालित करें; बिना एनक्लोजर के हाई-पावर एयरबोर्न अल्ट्रासाउंड कभी न चलाएं।
...
1. **शून्य से प्रतिलिपि योग्यता।** सोल्डरिंग आयरन और ~$210 रखने वाला कोई भी व्यक्ति केवल इस रेपो से परिणाम का पुनरुत्पादन कर सकता है।
2. **हर प्रयोग एक प्रोटोकॉल है।** कोई "यह कुछ हद तक काम कर गया" नहीं: [experiments/TEMPLATE.md](experiments/TEMPLATE.md) अनिवार्य है।
3. **पेटेंट स्वच्छता।** हम समाप्त परत ([docs/01-prior-art.md](docs/01-prior-art.md)) पर निर्माण करते हैं; निर्णय [docs/decisions/](docs/decisions/0001-frequency-mode-choice.md) में दर्ज किए जाते हैं।
4. **पहले माप, फिर राय।** चैनल के बारे में किसी भी निष्कर्ष से पहले एक स्वीप मैप।

## लाइसेंस और पेटेंट

कोड — Apache-2.0, हार्डवेयर — CERN-OHL-W v2, दस्तावेज़ीकरण — CC-BY-4.0; पूरे ग्रंथ [LICENSES/](../../LICENSES) में। कोई भी इसे फोर्क और बिल्ड कर सकता है, व्यावसायिक उपयोग सहित; पेटेंट सुरक्षा लाइसेंस के अनुदान और प्रतिशोध खंडों के साथ पूर्व-कला (prior-art) रणनीति से आती है। पूरी योजना और रक्षात्मक-प्रकाशन प्रोटोकॉल: [LICENSES.md](LICENSES.md); योगदान नियम: [CONTRIBUTING.md](CONTRIBUTING.md)।
