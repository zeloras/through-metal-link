...
3. **Доза, яку стінка приймає назад** — див. розділ [нижче](#доза-що-хвиля-робить-зі-стінкою-частота-за-частотою): напруження σ = √(2·I·Z), яке *не залежить* від частоти, та самонагрів ΔT ∝ α(f)·I, який залежить.
