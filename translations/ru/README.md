...
|---|---|---|---|
| 1. Свип-карта | АЧХ канала «ланжевен–сталь 3 мм–ланжевен» | найден резонанс пары, график в [experiments/001](experiments/001-sweep-map-3mm-steel/README.md) | [sim1](docs/img/sim1-sweep-contacts.png), [sim2](docs/img/sim2-pair-mismatch.png) |
| 2. Ватты | мощность в нагрузку на резонансе | ≥0.5 Вт через 3 мм стали | [sim4](docs/img/sim4-power-budget.png) |
